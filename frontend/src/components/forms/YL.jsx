            ...
            <form onSubmit={handleSubmit} >
                ...
                <div className="childreninfo">
                    ...
                    <div className="childreninfo__checkboxes">
                        <div class="childreninfo__checkboxes-item">
                            <input type="checkbox" name="camp" value="31 June — 04 July" />
                            <label for="31 July — 04 July">31 June — 04 July</label>
                        </div>

                        <div class="childreninfo__checkboxes-item">
                            <input type="checkbox" name="camp" value="08 August — 11 August" />
                            <label for="08 August — 11 August">08 August — 11 August</label>
                        </div>
                    </div>
